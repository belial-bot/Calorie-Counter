...
const I18n = (() => {
  ...
  const DICT = {
    de: {
      ...
      'qty.more': 'Mehr',
      'qty.unit': 'Einheit',
      'qty.base': 'entspricht {amount} {unit}',
      'toast.added': '{name} eingetragen.',
      'toast.updated': 'Geändert.',
      'toast.deleted': 'Gelöscht.',

      'new.title': 'Neues Lebensmittel',
      'new.note': 'Nährwerte pro 100 g oder 100 ml — so stehen sie auf fast jeder Verpackung. Das Stückgewicht ist freiwillig; trägst du es ein, kannst du später in Stück statt in Gramm eintragen.',
      'new.namePlaceholder': 'z. B. Skyr natur',
      'new.save': 'Weiter zur Menge',
      'new.noName': 'Der Name fehlt noch.',
      'field.name': 'Name',
      'field.kcal': 'Kalorien',
      'field.portion': 'Ein Stück wiegt',
      'field.portionUnit': 'je Stück',
      'field.pieceName': 'Ein Stück heißt',
      'field.baseUnit': 'Angaben pro 100',
      ...
      'unit.tbsp': 'EL',
      'unit.tsp': 'TL',
      'unit.handful': 'Handvoll',
      'unit.handfuls': 'Handvoll',
      ...
      'my.delete': 'Löschen',
      'my.manage': 'Verwalten',
      'my.addFood': 'Lebensmittel',
      'my.addCombo': 'Kombination',

      'nav.back': 'Zurück',
      'tag.combo': 'Kombi',

      'combo.title': 'Kombination anlegen',
      'combo.titleEdit': 'Kombination bearbeiten',
      'combo.note': 'Mische bestehende Lebensmittel zu einer neuen Portion, z. B. 50 g Fruchtmüsli, 500 g Skyr und 50 g Milch zu einer Frühstücksbowl.',
      'combo.namePlaceholder': 'z. B. Frühstücksbowl',
      'combo.addIngredient': '+ Zutat hinzufügen',
      'combo.empty': 'Noch keine Zutaten.',
      'combo.remove': 'Entfernen',
      'combo.needName': 'Der Name fehlt noch.',
      'combo.needIngredient': 'Füg mindestens eine Zutat hinzu.',
      'combo.wholePortion': 'Ganze Portion ({g} g)',
      'combo.piece': 'Portion',
      'combo.pieces': 'Portionen',
      'combo.save': 'Speichern',

      'new.saveDirect': 'Speichern',
      'new.editTitle': 'Lebensmittel bearbeiten',
      'toast.foodSaved': '{name} gespeichert.',
    ...
    en: {
      ...
      'qty.more': 'More',
      'qty.unit': 'Unit',
      'qty.base': 'that is {amount} {unit}',
      'toast.added': '{name} added.',
      'toast.updated': 'Updated.',
      'toast.deleted': 'Deleted.',

      'new.title': 'New food',
      'new.note': "Nutrition per 100 g or 100 ml — the way it's printed on the packaging. The piece weight is optional; enter it and you can log in pieces instead of grams later on.",
      'new.namePlaceholder': 'e.g. plain skyr',
      'new.save': 'Next: amount',
      'new.noName': 'The name is still missing.',
      'field.name': 'Name',
      'field.kcal': 'Calories',
      'field.portion': 'One piece weighs',
      'field.portionUnit': 'per piece',
      'field.pieceName': 'A piece is called',
      'field.baseUnit': 'Values are per 100',
      'field.optional': 'optional',
      ...
      'combo.title': 'Create a combo',
      'combo.titleEdit': 'Edit combo',
      'combo.note': 'Combine existing foods into one new item, e.g. 50 g fruit muesli, 500 g skyr and 50 g milk into a morning muesli bowl.',
      'combo.namePlaceholder': 'e.g. morning muesli bowl',
      'combo.addIngredient': '+ Add ingredient',
      'combo.empty': 'No ingredients yet.',
      'combo.remove': 'Remove',
      'combo.needName': 'The name is still missing.',
      'combo.needIngredient': 'Add at least one ingredient.',
      'combo.wholePortion': 'Whole batch ({g} g)',
      'combo.piece': 'batch',
      'combo.pieces': 'batches',
      'combo.save': 'Save',

      'new.saveDirect': 'Save',
      'new.editTitle': 'Edit food',
      'toast.foodSaved': '{name} saved.',
