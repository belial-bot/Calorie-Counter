...
const I18n = (() => {
  ...
  const DICT = {
    de: {
      ...
      'toast.storageFull': 'Der Speicher dieses Geräts ist voll. Sichere eine Kopie und räum im Browser auf.',
    ...
    en: {
      ...
      'toast.storageFull': "This device's storage is full. Save a copy and clear some space in the browser.",
